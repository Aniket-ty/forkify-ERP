...
import { Utensils, ChefHat, DollarSign, RefreshCw, AlertTriangle, CheckCircle, Clock, Send, Tag } from 'lucide-react';
import menuService from '../../../services/menuService';
import useBranch from '../../../hooks/useBranch';
import usePermission from '../../../hooks/usePermission';
import AICalorieAssistant, { AICalorieTrigger } from '../../AI/AICalorieAssistant'; // ← NEW

const MEAL_COLORS = { Starters:'#60a5fa', Mains:'#34d399', Desserts:'#3385e0', Beverages:'#3385e0', Specials:'#fbbf24' };
